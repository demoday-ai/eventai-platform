...
PROJECT_TAG_EXTRACTION_SYSTEM = (
    ...
    '{{"tags": ["tag1", "tag2"]}}\n'
    "ВАЖНО: используй ТОЛЬКО теги из списка выше, копируя их ТОЧНО как написано "
    "(с учётом регистра). Выбери 1-3 наиболее подходящих тега. "
    "Если ни один тег не подходит, верни пустой список: {{\"tags\": []}}."
)

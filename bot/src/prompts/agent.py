...
def build_agent_system_prompt(
    ...
    return (
        ...
        "- Изменить подборку: убрать/добавить проект или исключить тему -> update_program(remove=[номера], add=[номера], exclude=[темы]); "
        ...
        "update_program, rebuild_program, search_catalog) "

...
| `docs/customer-journeys.md` | Клиентские пути AS-IS → TO-BE по 4 ролям + таймлайн нового процесса |
| `docs/icp.md` | Ideal Customer Profile по 4 сегментам (организатор, эксперт, студент, гость) |
| `docs/pain-map.md` | Pain Map по сегментам: 10 болей с evidence из интервью, severity/frequency/reach |
| `docs/jtbd.md` | Jobs-To-Be-Done: 9 jobs по 4 сегментам с forces-анализом и desired outcomes |
| `docs/vpc.md` | Value Proposition Canvas: customer profile + value map по 4 сегментам |

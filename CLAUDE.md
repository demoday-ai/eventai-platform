...
На Demo Day много проектов и треков (150+ проектов в 6 параллельных залах за 2 дня), а времени у гостей мало: гость физически успевает посетить <20% проектов. Сложно быстро найти "свои" доклады/демо, сравнить проекты по нужным критериям и организовать содержательный Q&A. В итоге часть релевантных проектов остаётся незамеченной, а фоллоу-ап после мероприятия хаотичный.
...
Анализ реального Demo Day показал:
- **150+ проектов** за 2 дня
- **6 параллельных залов** (потоков)
- Тематики: EdTech, NLP, CV, FinTech, Healthcare, Legal, DevOps, GameDev, Robotics и др.
- Каждый проект -- 10-15 минут на презентацию + Q&A
- Гость физически не может посетить >15-20% проектов
- Примечание: Анастасия Гапеева участвовала в прошлом Demo Day с проектом "Нить" (UX/EdTech)
...
- Tinder-пары медленные и не масштабируются на 300+ проектов

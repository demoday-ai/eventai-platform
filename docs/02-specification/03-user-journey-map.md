...
> **Версия:** 1.1
> **Дата:** 2026-02-02
> **На основе:** Brief v3.0, USM v2.1, Customer Journeys (discovery), CustDev #1-#4
> **Изменения v1.1:** Гость: профилирование варианты+текст (Настя), уведомления о сдвигах тайминга, 5-10 мин. Встречи 1:1 снижены
...
journey
    ...
    section Профилирование (за неделю до DD)
      Выбирает тематики из вариантов + текст: 4: Гость
      Бот подтверждает профиль: 4: Гость
    section Персональная программа
      Получает подборку проектов: 5: Гость
      Просматривает брифы проектов: 4: Гость
    section Канун DD
      Напоминание с программой: 4: Гость
    section Во время DD
      Напоминание за 5 мин до проекта: 4: Гость
      Уведомление о сдвиге тайминга: 5: Гость
      Q&A-помощник (вопросы для проектов): 4: Гость
    section После DD
      Follow-up: конспект, рекомендации: 5: Гость
```
...
| Профилирование | Кнопки тематик + свободный текст | "Что вас интересует?" — варианты: NLP, CV, Agents... + ввод | Вовлечённость ("удобно поклацать") | 5-10 мин — не слишком ли долго? | US-009 |
| Подтверждение профиля | Бот показывает извлечённые интересы | "Вас интересует: NLP, CV, антифрод. Верно?" + кнопки | Удивление ("понял!") | AI неправильно понял | US-009 |
| Подборка проектов | Входящее сообщение | Проекты: название, описание, зал, время, релевантность | Вау-эффект (Настя: 5/5) | Слишком много информации | SS-006 |
| Брифы | По запросу — детальнее по проекту | 2-3 предложения, теги, автор, зал/время | Вовлечённость | — | US-010 |
| Напоминание | Автоматически за 5 мин | "Через 5 мин — проект [X], Зал [Y]" | Полезность | — | SS-008 |
| Сдвиг тайминга | Автоматически при изменении | "Проект [X] перенесён: [время1] → [время2]" | Облегчение ("не пропущу!") | Нет данных о сдвигах в реальном времени | SS-016 |
| Q&A-помощник | По запросу или автоматически | 3-5 вопросов под профиль | Уверенность (Настя: 3/5) | Вопросы поверхностные | US-012 |
| Follow-up | Входящее (после DD) | Конспект, рекомендации, next steps | Благодарность (Настя: 5/5) | — | SS-012 |
...
Гость        😐 →        —            😊 → 😊      😌      😊 →          😊
             роль,                    варианты+     напом.   напоминание,  follow-up
             подтип                   текст,подб.            сдвиги,Q&A    (5/5)
...
| 4 | Гость выбирает интересы | Гость | Не знает что выбрать → пустой профиль | Кнопки тематик (Настя: "поклацать") + свободный текст. Варианты снимают нерешительность |

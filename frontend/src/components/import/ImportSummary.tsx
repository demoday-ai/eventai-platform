...
import type { UploadResult, ExpertUploadResult } from "../../lib/api-client"

interface ImportSummaryProps {
  result: UploadResult | ExpertUploadResult
  type: "projects" | "experts"
}

function isUploadResult(result: UploadResult | ExpertUploadResult): result is UploadResult {

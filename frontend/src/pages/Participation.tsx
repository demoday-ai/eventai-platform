...
export function Participation() {
  ...
  useEffect(() => {
    document.title = `${APP_NAME} - Участие`
  }, [])
  ...
  return (
    <div className="grid gap-6">
      <h2 className="text-2xl font-bold">Участие</h2>

      {/* Broadcast */}
      <Card>
        <CardHeader>
          <CardTitle>Рассылка подтверждения участия</CardTitle>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Неподтверждённые</CardTitle>
        </CardHeader>
        <CardContent>

...
- **Домен**: `evt-ai.ru` (или другой номер команды)
...
ssh -J bastion.camp.aitalenthub.ru evt-ai.ru
...
TELEGRAM_WEBHOOK_URL=https://evt-ai.ru/api/v1/telegram/webhook
```
...
```bash
# Health check
curl https://evt-ai.ru/health

# API health check
curl https://evt-ai.ru/api/v1/health
...
curl -X POST "https://api.telegram.org/bot<BOT_TOKEN>/setWebhook" \
  ...
  -d '{"url": "https://evt-ai.ru/api/v1/telegram/webhook"}'
...
- Frontend: `https://evt-ai.ru/health`
- Backend API: `https://evt-ai.ru/api/v1/health`
